...
session_start();
  ...
  $datos = $proveedor->where('email',$correo)->findAll();

  foreach($datos as $libro ):
    $nombre=$libro['razon_social'];   
  endforeach;


?>
<nav class="navbar navbar-expand-lg navbar-light"  style="background-color: #36907A">
  <a class="navbar-brand logo" href="<?=Base_url('menu_empresa')?>"><img src="<?=base_url()?>/fotografias/logo.png" alt="EcoTour"  width="50" height="50"></a>
  ...
  <div class="collapse navbar-collapse" id="navbarScroll">
    ...
    <form class="d-flex"  method="post" action="<?=Base_url('buscar_e')?>" enctype="multipart/form-data">
