    ...
    <tr>
      ...
      <td><?=$calle?></td>
       ...
       <div class="col-sm">
           ...
           <a href = "<?=Base_url('reserva/'.$id_lugar)?>"class="btn" style="background-color: #36907A" > <b style="color:  #FDFEFE"><svg xmlns="http://www.w3.org/2000/svg" width="20" height="20"  style="color: #FDFEFE "fill="currentColor" class="bi bi-emoji-laughing" viewBox="0 0 16 16">
