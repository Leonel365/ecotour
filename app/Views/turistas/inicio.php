...
<div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
  ...
  <div class="carousel-inner">
    <div class="carousel-item active">
      <img src="../public/carousel/img1.jpeg" height="400" class="d-block w-100" alt="...">
    </div>
...
<!--   Aqui inicia el contenido -->
  ...
  <div class="row">
      <div class="col-sm">
        ...
        <a href = "<?=Base_url('categorias_t')?>" class="btn" style="background-color: #36907A" > <b style="color:  #FDFEFE"> Hoy quierio ir a ... </b><svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" class="bi bi-question-circle-fill" viewBox="0 0 16 16" style="color: #FDFEFE">
