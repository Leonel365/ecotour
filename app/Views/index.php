...
<!--   Aqui inicia el contenido -->
  ...
  <div class="row">
      <div class="col-sm">
        ...
        <a href = "<?=Base_url('categorias')?>"class="btn" style="background-color: #36907A" > <b style="color:  #FDFEFE"> Hoy quierio ir a ... </b><svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" class="bi bi-question-circle-fill" viewBox="0 0 16 16" style="color: #FDFEFE">
